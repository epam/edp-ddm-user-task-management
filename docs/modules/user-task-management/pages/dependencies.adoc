...
[plantuml]
----
include::partial$get-task-list.puml[]
----
...
=== Отримати перелік виконаних задач користувача

Діаграма послідовності отримання переліку виконаних задач користувача:

[plantuml]
----
include::partial$get-historic-task-list.puml[]
----
...
[source]
----
GET /api/history/task --header 'X-Access-Token: token'
----
...
[plantuml]
----
include::partial$claim-task.puml[]
----
...
[plantuml]
----
include::partial$unclaim-task.puml[]
----
...
[plantuml]
----
include::partial$complete-task.puml[]
----
...
[plantuml]
----
include::partial$sign-officer-task.puml[]
----
...
[plantuml]
----
include::partial$sign-citizen-task.puml[]
----
